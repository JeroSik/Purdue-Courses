...
int main(int argc, char ** argv) {
	...
	program_name = program_name.substr(0, program_name.size() - 5);
    ...
    // Traverses AST to generate ARM assembly code if no semantic errors
    generator * gen = new generator();
    gen->generateProgram(root, program_name, args);
