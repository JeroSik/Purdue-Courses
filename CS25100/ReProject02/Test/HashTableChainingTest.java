...
public class HashTableChainingTest {
    ...
    public void setUp() throws Exception {
        Scanner s = new Scanner(new File("./Test/test.txt"));
    ...
    public void mostFrequentStrings() throws Exception {
        ...
        ArrayList<String> expectedRes = new ArrayList<>(Arrays.asList("ZmPJaMhiUr", "szDZHwYiHQ", "uNjsnFOxLW", "RAdPVwcVSf", "WVetUMccSY"));
